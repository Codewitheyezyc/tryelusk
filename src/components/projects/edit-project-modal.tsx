...
export function EditProjectModal({ project, isOpen, onClose }: EditProjectModalProps) {
  ...
  useEffect(() => {
    if (project) {
      ...
      setGenre(project.genre || "Cyberpunk / Sci-Fi");
      setAspectRatio(project.aspectRatio || "16:9");
      setTargetFps(project.targetFps || 24);
    }
  }, [project]);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base sm:text-lg font-extrabold text-white tracking-tight">
                Edit Film Project Settings
              </h2>
              <p className="text-xs text-[#8B8B96] mt-0.5">
                Update film title, synopsis, master canvas ratio, and frame rate.
              </p>
            </div>
          </div>
          ...
          <div className="p-5 sm:p-6 space-y-4 flex-1 overflow-y-auto custom-scrollbar">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                rows={2}
                placeholder="Describe the story core (used by AI Director for stylistic coherence)..."
